...
Hi! I'm **Nam** (also known as **Izumi** 🎋) — an AI Researcher based in Hanoi, Vietnam.

- 🎓 **B.Sc. Computer Science** @ [FPT University](https://fpt.edu.vn) *(Data Science & AI — GPA 3.1/4.0)*
- 🔬 **Research Assistant** @ [Business AI Lab](https://tvluong.wordpress.com/), National Economics University
...
| | Area | Focus |
|---|------|-------|
| 🧠 | **Explainable AI** | Multimodal XAI for Healthcare & Business/Economics |
| 🎭 | **Multimodal Learning** | Vision-Language Models, ECG + LLM fusion |
| 🤖 | **Multi-agent Systems** | Agentic LLM pipelines, JEPA-based representation learning |
| 🏥 | **AI for Healthcare** | Clinical decision support, ECG cardiac analysis |
...
**[C.1]** Hai-Nam Vuong Duy, Trang Mai Xuan, Luong Thien Van.  
*"Enhancing Explainable Cardiac Diagnosis with Guide-Grounded Multimodal LLMs"*  
📍 **CITA 2026** · 15th Conference on Information Technology and its Applications · Springer · ✅ *Accepted*
...
- Reviewer — **FJCAI 2026** (Fisu Joint Conference on AI)
- Reviewer — **CITA 2026** (Springer)
...
|---------|-------------|--------|
| 🏥 **XAI for ECG** | Explainable cardiac diagnosis with Guide-Grounded Multimodal LLMs | 🔬 Research |
| 📚 **EduVision** | AI-powered educational platform | 🏗️ Building |
| 🌊 **Flood Detection** | Image retrieval for disaster response (DPL302m / Kaggle) | 📊 Competing |
...
[![Website](https://img.shields.io/badge/Website-nonomiyaizumi.github.io-FF6B6B?style=for-the-badge&logo=githubpages&logoColor=white)](https://nonomiyaizumi.github.io/Profile_web/)
[![GitHub](https://img.shields.io/badge/GitHub-NonomiyaIzumi-181717?style=for-the-badge&logo=github)](https://github.com/NonomiyaIzumi)
...
[![Email](https://img.shields.io/badge/Email-namvdh.bai%40st.neu.edu.vn-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:namvdh.bai@st.neu.edu.vn)
[![Telegram](https://img.shields.io/badge/Telegram-%40IzumiNonomiya-2CA5E0?style=for-the-badge&logo=telegram)](https://t.me/IzumiNonomiya)
[![Instagram](https://img.shields.io/badge/Instagram-%40nonomiyaizumi-E4405F?style=for-the-badge&logo=instagram&logoColor=white)](https://www.instagram.com/nonomiyaizumi/)
