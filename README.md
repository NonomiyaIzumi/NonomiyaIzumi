...
| | Area | Focus |
|---|------|-------|
| 🧠 | **Explainable AI** | Interpretable multimodal AI for Healthcare & Business/Economics |
| 🎭 | **Multimodal Learning** | ECG images, vision-language models, and clinical decision support |
| ✨ | **Generative AI** | Multimodal LLMs and grounded explanation generation |
| 🤖 | **Multi-agent Systems** | RAG and agentic AI pipelines |
...
**[C.1]** Hai-Nam Vuong Duy, Trang Mai Xuan, Luong Thien Van. (2026).  
*"Enhancing Explainable Cardiac Diagnosis with Guide-Grounded Multimodal LLMs"*  
📍 **CITA 2026** · 15th Conference on Information Technology and its Applications · ✅ *Accepted*

**Academic Service**

- Reviewer — **FJCAI 2026**, Fisu Joint Conference on Artificial Intelligence *(2025)*
- Reviewer — **CITA 2026**, Conference on Information Technology and its Applications, Springer *(2026)*
- Reviewer — **ICDM 2026**, IEEE International Conference on Data Mining *(2026)*
...
<div>
  <img src="https://skillicons.dev/icons?i=python,latex&theme=dark" />
</div>
...
**LLM APIs, Deployment & Agentic AI**
...
<div>
  ...
  <img src="https://img.shields.io/badge/Qwen-Self--hosted-615CED?style=flat-square&logoColor=white" />
  <img src="https://img.shields.io/badge/RAG-2E8B57?style=flat-square&logoColor=white" />
  <img src="https://img.shields.io/badge/Multi--agent_Systems-FF6B6B?style=flat-square&logoColor=white" />
</div>
...
|---------------|--------|------|
| **Fundamentals of Deep Learning** | NVIDIA | Jul 2026 |
...
**Dr. Thien Van Luong** — PhD, Leader of Business AI Lab, Department of Computer Science, National Economics University  
[Personal Page](https://tvluong.wordpress.com/) · [thienlv@neu.edu.vn](mailto:thienlv@neu.edu.vn) · *Supervisor*
